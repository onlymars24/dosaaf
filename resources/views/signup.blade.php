...
<section class="contant">
  ...
  <div class="form-registration">
      <!--  -->
      <form class="row g-3 needs-validation" action="{{route('signup.handler')}}" autocomplete="on" method="POST">
        @csrf
      ...
      @endif
        ...
        <div class="col-md-12">
          <label for="inputRegion" class="form-label">Вы являетесь</label>
          <select class="form-select" name="status" id="inputRegion" maxlength="60">
            <option selected disabled value="">Выберите...</option>
            <option value="natural">Физ. лицом</option>
            <option value="legal">Юр. лицо</option>
            <option value="special">Особая категория</option>
          </select>
        </div>
        <div class="col-12">
          <div class="form-check">
            <input
              class="form-check-input {{!empty($errors->first('check-private-policy')) ? 'is-invalid' : '' }}"
              type="checkbox"
              name="check-private-policy"
              id="invalidCheck"/>
            ...
            <label class="form-check-label" for="invalidCheck">
              <span style="color: black;">
                Я согласен
                <a
                  class="link-private-police"
                  href="https://dosaaf-kropotkin.ru/private-policy">
          ...
          @if(!empty($errors->first('check-private-policy')))
            <div class="invalid-feedback d-block"> {{$errors->first('check-private-policy')}}
            </div>            
          @endif
        </div>
        <div class="col-12">
