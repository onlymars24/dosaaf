@extends('layout')
@section('title', 'Страница очных курсов')
@section('h1', 'Страница очных курсов')
@section('content')
          <div class="container container-content">
            <div class="block-left">
              <aside
                class="block-left__all-aside block-left__categories no-input"
              >
                <input type="checkbox" id="categories" />
                <label
                  for="categories"
                  class="label-header categories-header headers-block-left"
                  >Категория курса
                </label>
                <label class="menu__backgraund-close" for="categories"></label>
                <ul
                  class="block-left__list-categories-all block-left__list-all"
                >
                @php
                  $activeCate = '';
                  $activeType = '';                
              ...
              <aside
                class="block-left__all-aside block-left__type-of-training no-input"
              >
                <input type="checkbox" id="type-of-training" />
                <label
                  for="type-of-training"
                  class="label-header headers-block-left"
                  >Тип <span class="label-header-pc">обучения</span>
                </label>
                <label
                  class="menu__backgraund-close"
                  for="type-of-training"
                ></label>
              ...
              <div class="row g-3 block-right__content">
                ...
                <div class="col-12">
                  <div class="block-right__card block-right__card__scale">
                    <div style="background-image: url('{{$intramural->avatar}}')" class="card__img">
                    </div>
                    ...
                    <div class="card__complete-training">
                      <a href="{{route('intramural', ['id' => $intramural->id])}}">Узнать больше</a>
                    </div>
                  </div>
                </div>
                @endforeach
